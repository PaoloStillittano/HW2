<html>
    ...
    <head>
        ...
        <script src='<?php echo e(url("js/posts.js")); ?>' defer="true"></script>
    ...
    <body>
        ...
        <section>
            <div class="menu">
                <h2>Benvenuto <?php echo e($username); ?>!</h2>
                <div class='prova'>
                    <p><a href="<?php echo e(url('recensioni')); ?>">Recensioni</a></p></br>
                    <p><a href="<?php echo e(url('search')); ?>">Search</a></p></br>
                    <p><a href="<?php echo e(url('logout')); ?>"> Esci dalla sessione</a></p></br>
                </div>
            </div>
