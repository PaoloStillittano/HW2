<html>
    <head>
        ...
        <script src='<?php echo e(url("js/recensioni.js")); ?>' defer="true"></script>
    ...
    <body>
        <section class='grid'>
            ...
            <div class="menu">
                    <p><a href="<?php echo e(url('home')); ?>">Home</a></p></br>
                    <p><a href="<?php echo e(url('logout')); ?>"> Esci dalla sessione</a></p></br>
            </div>
        </section>
    </body>    
</html><?php /**PATH C:\xampp\htdocs\homework\resources\views/recensioni.blade.php ENDPATH**/ ?>